...
resource "aws_iam_policy" "policy_AccountAdmin" {
  ...
  description = "A policy CrossAccountAdmin"
...
resource "aws_iam_policy" "policy_ReadOnlyAccess" {
  name        = "policy_ReadOnlyAccess"
  description = "A policy ReadOnlyAccess"
...
resource "aws_iam_policy" "policy_AWSSupportAccess" {
  ...
  description = "A policy AWSSupportAccess"
...
resource "aws_iam_role_policy_attachment" "attach_AccountSignin1" {
  ...
  policy_arn = aws_iam_policy.policy_ReadOnlyAccess.arn
}
...
resource "aws_iam_policy" "policy_Billing" {
  name        = "policy_Billing"
  description = "A policy CrossAccountBilling"
